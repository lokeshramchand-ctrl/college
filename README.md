...
- Next.js automatic code splitting for faster page loads
- Image optimization with lazy loading
- CSS-based animations for smooth 60fps performance
- Minimal JavaScript overhead
- Responsive design reduces need for separate mobile version
...
Use vanilla CSS with the following conventions:

- Define reusable CSS variables at the component level
- Use consistent naming patterns for classes (e.g., `component-name`, `component-name-element`)
- Include media queries within component stylesheets
- Avoid hardcoding values; use CSS variables instead

### Components

- Keep components focused and reusable
- Use TypeScript interfaces for prop definitions
- Style components with inline CSS in `<style>` tags or linked stylesheets
...
This project is private and maintained by IIT BHU Varanasi.

## Support

For questions or issues regarding this project, please contact the development team or submit an issue in the repository.
